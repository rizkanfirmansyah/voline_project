            ...
            <table class="table align-items-center table-flush table-sm" id="table">
              ...
              <tbody class="list">
                    <tr>
                        ...
                        <td class="text-center">{{QrCode::size(25)->generate('https://'.$_SERVER['HTTP_HOST'].'/auth/register')}}</td>
                        <td><a href="/master/sibarcode/print/dataqr?url={{urlencode('https://'.$_SERVER['HTTP_HOST'].'/auth/login')}}" target="_blank" class="badge badge-primary"><i class="fas fa-print"></i> Cetak</a></td>
                    </tr>
                    <tr>
                        <td>2</td>
                        <td>Form Login</td>
                        <td><a href="#">http://{{$_SERVER['HTTP_HOST']}}/auth/login</a></td>
                        <td class="text-center">{{QrCode::size(25)->generate('https://'.$_SERVER['HTTP_HOST'].'/auth/login')}}</td>
                        <td><a href="/master/sibarcode/print/dataqr?url={{urlencode('https://'.$_SERVER['HTTP_HOST'].'/auth/login')}}" target="_blank" class="badge badge-primary"><i class="fas fa-print"></i> Cetak</a></td>
                    </tr>
              </tbody>
            </table>
